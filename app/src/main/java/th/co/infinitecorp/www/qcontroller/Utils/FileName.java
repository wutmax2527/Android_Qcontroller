...
public  class FileName {
    ...
    public static String  StaInfo_JSON = "StaInfo.json";
    public static String  BreakInfo_JSON = "BreakInfo.json";
    public static String GrpInfo_JSON = "GrpInfo.json";
    public static String UserInfo_JSON = "UserInfo.json";
    public static String EmployeeInfo_JSON = "EmployeeInfo.json";
    public static String DivisionAdvInfo_JSON = "DivisionAdvInfo.json";

    public static String PF_DIVISION_JSON = "PF_DIVISION.json";
    public static String PF_STAMAP_JSON = "PF_STAMAP.json";
    public static String PF_DIVMAP_JSON = "PF_DIVMAP.json";
    ...
    public static String Queue_JSON="queue.json";
    public static String Queuelog_JSON="queuelog.json";
    public static String User_JSON="user.json";
    public static String Userlog_JSON="userlog.json";
    public static String Counterlog_JSON="counterlog.json";
